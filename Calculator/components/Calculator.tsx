...
function Calculator() {
  ...
  return (
    ...
    <div className='relative  left-48 top-32 bg-slate-100 w-fit	'>
        ...
        <div className='w-min'>
        <button className='size-32 border-2 border-gray-800 ' value='Clear' onClick={handleInput}>Clear</button>
